...
BOOTSTRAP_BOUNDS_SCHEMA = """
    ...
    volume_delta_threshold_min DOUBLE,
    volume_delta_threshold_max DOUBLE,
...
class ColdStore:
    ...
    async def get_latest_bootstrap_result(
        ...
        return BootstrapResult(
            ...
            volume_delta_threshold=float(row["volume_delta_threshold"]),
    ...
    async def get_latest_bootstrap_bounds(
        ...
        return BootstrapBounds(
            ...
            optimized_bound_volume_delta_threshold=(
                float(row["volume_delta_threshold_min"]),
                float(row["volume_delta_threshold_max"]),
            ),
