...
struct HotStore(Movable, Sized):
    ...
    fn __moveinit__(out self, deinit other: Self):
        ...
        self.minute_index = other.minute_index
        self.current_minute = other.current_minute
        self.base_day_ms = other.base_day_ms
        self.total_added = other.total_added
        self.total_cleared = other.total_cleared
